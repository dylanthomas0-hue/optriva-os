...
export const SITES: Site[] = [
  { id: "bestaiagentcommunity",  name: "bestaiagentcommunity.com",   url: "https://bestaiagentcommunity.com",  path: path.join(os.homedir(), "REDACTED.com"),         postsDir: path.join(os.homedir(), "REDACTED.com", "src/blog/posts") },
  { id: "REDACTED",     name: "REDACTED.com",      url: "https://REDACTED.com",     path: path.join(os.homedir(), "REDACTED-main"),         postsDir: path.join(os.homedir(), "REDACTED-main", "src/blog/posts") },
  { id: "REDACTEDautomation", name: "REDACTEDaiautomation.com", url: "https://REDACTEDaiautomation.com", path: path.join(os.homedir(), "REDACTEDaiautomation"), postsDir: path.join(os.homedir(), "REDACTEDaiautomation", "src/blog/posts") },
  { id: "aisuccesslab",          name: "aisuccesslabREDACTED.com", url: "https://aisuccesslabREDACTED.com", path: path.join(os.homedir(), "aisuccesslab"),                postsDir: path.join(os.homedir(), "aisuccesslab", "src/blog/posts") },
  { id: "aimoneylab",            name: "aimoneylabREDACTED.com", url: "https://aimoneylabREDACTED.com", path: path.join(os.homedir(), "aimoneylab"),                  postsDir: path.join(os.homedir(), "aimoneylab", "src/blog/posts") },
];

export const TRANSCRIPTS_DIR = path.join(os.homedir(), "REDACTED.com", ".claude", "transcripts");
export const BLOG_POST_SKILL = path.join(os.homedir(), "REDACTED.com", ".claude", "skills", "blog-post.md");
