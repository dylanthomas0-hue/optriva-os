...
export async function hermesOneShot(profile: string, prompt: string, timeoutMs = 200_000): Promise<string> {
  ...
  const fallback = primary === "REDACTED" ? "kimi-highspeed" : "REDACTED";
...
- Lead with the FREE option: AI Money Lab (free AI + SEO community + 1,000 AI agents) → https://www.skool.com/ai-seo-with-REDACTED-1553/about
- Then upsell: REDACTED ($59/mo, step-by-step tutorials + weekly coaching, named #1 AI community by FatRank) → https://www.skool.com/ai-profit-lab-7462/about
- All URLs must be real markdown links [text](url).

Use a styled callout box for the main CTA like:
> **🔥 Want the exact setup?**
> Inside [AI Money Lab](https://www.skool.com/ai-seo-with-REDACTED-1553/about) I walk through this step by step — free, with 1,000+ AI agents and a community building real automations.
> **[→ Get free access here](https://www.skool.com/ai-seo-with-REDACTED-1553/about)**
