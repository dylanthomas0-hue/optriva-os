...
export default function SEOView() {
  ...
  function siteIdFromPath(filePath: string): string | null {
    if (filePath.includes("/REDACTED.com/"))    return "bestaiagentcommunity";
    if (filePath.includes("/REDACTED-main/"))   return "REDACTED";
    if (filePath.includes("/REDACTEDaiautomation/")) return "REDACTEDautomation";
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {/* REDACTED share-pack actions — let members open the setup guide or grab
        ...
        <a
          ...
          title="Open the step-by-step SEO setup guide for REDACTED members"
        >
                  ...
                  <div className="flex items-center justify-between text-[11px]">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        title={`Saves to ~/REDACTED.com/.claude/transcripts/${slug || "<slug>"}.txt`}
                      >
