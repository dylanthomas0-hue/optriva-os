...
> 👤 **These are YOUR profiles, not anyone else's.** The dashboard reads them from **your own** `~/.hermes/profiles/` folder on your Mac — nothing is shared or downloaded. If you've seen REDACTED's screenshot with a long row of profiles (REDACTED, glm-seo, jarvis, …), those live only on *his* computer. You see *yours*; he sees *his*. Not a bug. 🙂
