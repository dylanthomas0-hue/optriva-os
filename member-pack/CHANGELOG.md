...
- 🔒 **More de-personalisation** — removed a leftover "REDACTED Bench" label from a workspace folder so your install stays generic.
...
*Want the very latest? Download the newest pack from the REDACTED, then double-click `Update Agent OS.command`.*
